...
public final class Localization {
	public static final ResourceBundle BUNDLE = createBundle("net.playerxess.mpfapi.fabricloaderresources.loader.Messages", Locale.getDefault());
	public static final ResourceBundle ROOT_LOCALE_BUNDLE = createBundle("net.playerxess.mpfapi.fabricloaderresources.loader.Messages", Locale.ROOT);
