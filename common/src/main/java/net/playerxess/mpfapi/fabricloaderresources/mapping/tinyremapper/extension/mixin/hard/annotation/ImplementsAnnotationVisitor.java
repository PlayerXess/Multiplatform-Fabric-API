...
import net.playerxess.mpfapi.fabricloaderresources.mapping.tinyremapper.extension.mixin.common.data.Pair;
import net.playerxess.mpfapi.fabricloaderresources.mapping.tinyremapper.extension.mixin.hard.data.SoftInterface;
import net.playerxess.mpfapi.fabricloaderresources.mapping.tinyremapper.extension.mixin.hard.data.SoftInterface.Remap;
import net.playerxess.mpfapi.fabricloaderresources.mapping.tinyremapper.extension.mixin.hard.util.HardTargetMappable;
import net.playerxess.mpfapi.fabricloaderresources.mapping.tinyremapper.extension.mixin.hard.util.PrefixString;
