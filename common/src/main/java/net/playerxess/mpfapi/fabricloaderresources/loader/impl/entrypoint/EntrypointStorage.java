...
package net.playerxess.mpfapi.fabricloaderresources.loader.impl.entrypoint;
...
import net.playerxess.mpfapi.fabricloaderresources.loader.api.EntrypointException;
import net.playerxess.mpfapi.fabricloaderresources.loader.api.LanguageAdapter;
import net.playerxess.mpfapi.fabricloaderresources.loader.api.LanguageAdapterException;
import net.playerxess.mpfapi.fabricloaderresources.loader.api.entrypoint.EntrypointContainer;
import net.playerxess.mpfapi.fabricloaderresources.loader.impl.ModContainerImpl;
...
public final class EntrypointStorage {
	...
	private static class OldEntry implements Entry {
		private static final net.playerxess.mpfapi.fabricloaderresources.loader.language.LanguageAdapter.Options options = net.playerxess.mpfapi.fabricloaderresources.loader.language.LanguageAdapter.Options.Builder.create()
				.missingSuperclassBehaviour(net.playerxess.mpfapi.fabricloaderresources.loader.language.LanguageAdapter.MissingSuperclassBehavior.RETURN_NULL)
				.build();
		...
		public synchronized <T> T getOrCreate(Class<T> type) throws Exception {
			if (object == null) {
				net.playerxess.mpfapi.fabricloaderresources.loader.language.LanguageAdapter adapter = (net.playerxess.mpfapi.fabricloaderresources.loader.language.LanguageAdapter) Class.forName(languageAdapter, true, FabricLauncherBase.getLauncher().getTargetClassLoader()).getConstructor().newInstance();
