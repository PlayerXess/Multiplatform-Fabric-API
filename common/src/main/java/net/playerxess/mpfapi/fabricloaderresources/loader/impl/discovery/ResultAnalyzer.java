...
import net.playerxess.mpfapi.fabricloaderresources.loader.impl.discovery.ModSolver.AddModVar;
import net.playerxess.mpfapi.fabricloaderresources.loader.impl.discovery.ModSolver.InactiveReason;
...
import net.playerxess.mpfapi.fabricloaderresources.loader.impl.util.StringUtil;
import net.playerxess.mpfapi.fabricloaderresources.loader.impl.util.version.VersionIntervalImpl;
