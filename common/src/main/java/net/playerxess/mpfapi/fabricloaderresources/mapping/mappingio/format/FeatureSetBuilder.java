...
import net.playerxess.mpfapi.fabricloaderresources.mapping.mappingio.format.FeatureSet.ClassSupport;
import net.playerxess.mpfapi.fabricloaderresources.mapping.mappingio.format.FeatureSet.DescSupport;
import net.playerxess.mpfapi.fabricloaderresources.mapping.mappingio.format.FeatureSet.ElementCommentSupport;
import net.playerxess.mpfapi.fabricloaderresources.mapping.mappingio.format.FeatureSet.FeaturePresence;
import net.playerxess.mpfapi.fabricloaderresources.mapping.mappingio.format.FeatureSet.LocalSupport;
import net.playerxess.mpfapi.fabricloaderresources.mapping.mappingio.format.FeatureSet.MemberSupport;
import net.playerxess.mpfapi.fabricloaderresources.mapping.mappingio.format.FeatureSet.MetadataSupport;
import net.playerxess.mpfapi.fabricloaderresources.mapping.mappingio.format.FeatureSet.NameSupport;
import net.playerxess.mpfapi.fabricloaderresources.mapping.mappingio.format.FeatureSetImpl.ClassSupportImpl;
import net.playerxess.mpfapi.fabricloaderresources.mapping.mappingio.format.FeatureSetImpl.DescSupportImpl;
import net.playerxess.mpfapi.fabricloaderresources.mapping.mappingio.format.FeatureSetImpl.LocalSupportImpl;
import net.playerxess.mpfapi.fabricloaderresources.mapping.mappingio.format.FeatureSetImpl.MemberSupportImpl;
import net.playerxess.mpfapi.fabricloaderresources.mapping.mappingio.format.FeatureSetImpl.NameSupportImpl;
