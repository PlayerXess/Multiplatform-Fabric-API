...
package net.playerxess.mpfapi.impl.resourceloader;
...
import net.playerxess.mpfapi.api.resourceloader.ModResourcePack;
import net.playerxess.mpfapi.api.resourceloader.ResourcePackActivationType;
