...
package net.playerxess.mpfapi.impl.command.client;

import static net.playerxess.mpfapi.api.command.client.ClientCommandManager.argument;
import static net.playerxess.mpfapi.api.command.client.ClientCommandManager.literal;
...
import net.playerxess.mpfapi.api.command.client.FabricClientCommandSource;
import net.playerxess.mpfapi.mixins.command.HelpCommandAccessor;
