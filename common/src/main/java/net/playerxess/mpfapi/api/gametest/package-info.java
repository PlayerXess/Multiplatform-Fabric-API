 ...
 * net.minecraft.test.GameTest#templateName()} as {@link net.playerxess.mpfapi.api.gametest.v1.FabricGameTest#EMPTY_STRUCTURE}.
 ...
 * @see net.playerxess.mpfapi.api.gametest.v1.FabricGameTest
 */
package net.playerxess.mpfapi.api.gametest;
