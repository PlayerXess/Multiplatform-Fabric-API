 ...
 * {@link net.playerxess.mpfapi.api.resource.ResourceManagerHelper#registerBuiltinResourcePack(net.minecraft.util.Identifier, net.fabricmc.loader.api.ModContainer, net.playerxess.mpfapi.api.resource.ResourcePackActivationType)}</p>
 *
 ...
 * {@link net.playerxess.mpfapi.api.resource.ResourceManagerHelper#registerReloadListener(net.playerxess.mpfapi.api.resource.IdentifiableResourceReloadListener)},
 * which are triggered when resources are reloaded.
 * A resource reload listener can depend on another and vanilla resource reload listener identifiers may be found in {@link net.playerxess.mpfapi.api.resource.ResourceReloadListenerKeys}.</p>
 */

package net.playerxess.mpfapi.api.resourceloader;
